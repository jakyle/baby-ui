...
module.exports = {
  ...
  safelist: [{
      ...
      pattern: /text-(slate|gray|zinc|neutral|stone|red|orange|amber|yellow|lime|green|emerald|teal|cyan|sky|blue|indigo|violet|purple|fuchsia|pink|rose)-(2|3)00/
    },
    'animate-wiggle',
